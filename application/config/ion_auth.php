...
*/
$config['tables']['users']           = 'surnames_users';
$config['tables']['groups']          = 'surnames_groups';
$config['tables']['users_groups']    = 'surnames_users_groups';
$config['tables']['login_attempts']  = 'surnames_login_attempts';
