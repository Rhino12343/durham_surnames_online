...
*/
$config['tables']['users']           = 'DSO_users';
$config['tables']['groups']          = 'DSO_groups';
$config['tables']['users_groups']    = 'DSO_users_groups';
$config['tables']['login_attempts']  = 'DSO_login_attempts';
